...
from asr_model.ops import get_edit_distance, read_wav_data
from asr_model.config import load_pinyin_dict
...
class ModelSpeech:
    ...
    def __init__(self, speech_model, model_language_path, speech_features, max_label_length=64):
        self.data_loader = None
        self.speech_model = speech_model
        self.trained_model, self.base_model = speech_model.get_model()
        self.speech_features = speech_features
        self.max_label_length = max_label_length
        self.dict_path = model_language_path + "/" + ModelSpeech.DICT_PATH
    ...
    def recognize_speech(self, wavsignal, fs):
        ...
        # 获取拼音列表
        list_symbol_dic, _ = load_pinyin_dict(self.dict_path)
